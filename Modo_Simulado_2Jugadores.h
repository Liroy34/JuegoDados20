#ifndef MODO_SIMULADO_2JUGADORES_H_INCLUDED
#define MODO_SIMULADO_2JUGADORES_H_INCLUDED

void Simulado_2Jugadores(string &Nombre1,string &Nombre2,string &NPMAX,int &PuntajeTotalJugador1,int &PuntajeTotalJugador2,int &C,int &PMAX,int &D){
 int CR=0;
...
for(l=0;l<2;l++){
            ...
            cargarVector(vDados,5-j);                  ///GIRAN LOS DADOS
...
#endif // MODO_SIMULADO_2JUGADORES_H_INCLUDED
