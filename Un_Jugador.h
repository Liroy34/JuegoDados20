#ifndef UN_JUGADOR_H_INCLUDED
#define UN_JUGADOR_H_INCLUDED

#include "DIBUJO_DADOS.h"

void Un_Jugador(string &Nombre1,string &NPMAX,int &PuntajeTotalJugador1,int &C,int &PMAX,int &D){
     int CR=0;
...
Puntaje=0;
            ...
            cargarAleatorio(vDados,5-j,6);                   ///GIRAN LOS DADOS (5-j) es para que cada vez cargue y muestre un dado menos
